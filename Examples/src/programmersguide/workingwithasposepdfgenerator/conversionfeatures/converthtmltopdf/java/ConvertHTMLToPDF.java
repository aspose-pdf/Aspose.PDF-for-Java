...
package programmersguide.workingwithasposepdfgenerator.conversionfeatures.converthtmltopdf.java;
...
public class ConvertHTMLToPDF
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdfgenerator/conversionfeatures/converthtmltopdf/data/";
