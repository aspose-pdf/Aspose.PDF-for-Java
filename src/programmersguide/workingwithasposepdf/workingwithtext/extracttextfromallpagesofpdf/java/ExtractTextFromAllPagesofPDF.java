...
package programmersguide.workingwithasposepdf.workingwithtext.extracttextfromallpagesofpdf.java;

import com.aspose.pdf.*;

public class ExtractTextFromAllPagesofPDF
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/extracttextfromallpagesofpdf/data/";
