---
title: Working with Document Conversion - DOM
type: docs
weight: 20
...
- [Convert PDF to HTML format](/pdf/java/convert-pdf-to-html-format/)
- [Convert PDF to DOC and DOCX](/pdf/java/convert-pdf-to-doc-and-docx/)
- [Convert PDF to Excel XLS and XLSX](/pdf/java/convert-pdf-to-excel-xls-and-xlsx/)
- [Convert PDF to PowerPoint PPTX](/pdf/java/convert-pdf-to-powerpoint-pptx/)
