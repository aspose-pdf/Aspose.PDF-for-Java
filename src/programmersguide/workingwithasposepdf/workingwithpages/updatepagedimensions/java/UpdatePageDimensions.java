...
package programmersguide.workingwithasposepdf.workingwithpages.updatepagedimensions.java;
...
public class UpdatePageDimensions
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithpages/updatepagedimensions/data/";
