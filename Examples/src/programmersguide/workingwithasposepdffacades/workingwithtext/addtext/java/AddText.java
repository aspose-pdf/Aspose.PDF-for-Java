...
package programmersguide.workingwithasposepdffacades.workingwithtext.addtext.java;
...
public class AddText
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdffacades/workingwithtext/addtext/data/";
