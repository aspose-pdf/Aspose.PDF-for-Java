...
package programmersguide.workingwithasposepdf.workingwithdocument.validatepdfforpdfastandard.java;
...
public class ValidatePDFforPDFAStandard
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithdocument/validatepdfforpdfastandard/data/";
