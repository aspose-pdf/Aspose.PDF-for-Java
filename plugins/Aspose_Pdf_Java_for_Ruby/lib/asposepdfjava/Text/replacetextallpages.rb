module Asposepdfjava
  module ReplaceTextAllPages
    def run
        ...
        pdf_document = Asposepdfjava.java_class('com.aspose.pdf.Document').new(data_dir + 'input.pdf')

        # Create TextAbsorber object to find all instances of the input search phrase
        text_fragment_absorber = Asposepdfjava.java_class('com.aspose.pdf.TextFragmentAbsorber').new("sample")
        ...
        text_fragment = Asposepdfjava.java_class('com.aspose.pdf.TextFragment')
