...
package programmersguide.workingwithasposepdf.workingwithimages.convertpdfpages.java;
...
public class ConvertPDFPages
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithimages/convertpdfpages/data/";
