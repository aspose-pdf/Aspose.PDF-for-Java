...
package programmersguide.workingwithasposepdf.workingwithtext.searchandgettextfrompageofpdfdoc.java;

import com.aspose.pdf.*;

public class SearchandGetTextfromPageofPDFDoc
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/searchandgettextfrompageofpdfdoc/data/";
