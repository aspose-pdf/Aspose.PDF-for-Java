...
package programmersguide.workingwithasposepdffacades.workingwithstampswatermarks.addpagenumberinpdf.java;
...
public class AddPageNumberInPDF
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdffacades/workingwithstampswatermarks/addpagenumberinpdf/data/";
        //open document
