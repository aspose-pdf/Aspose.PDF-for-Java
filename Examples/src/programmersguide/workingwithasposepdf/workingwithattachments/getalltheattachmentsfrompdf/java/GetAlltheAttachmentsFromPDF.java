...
package programmersguide.workingwithasposepdf.workingwithattachments.getalltheattachmentsfrompdf.java;

import com.aspose.pdf.*;

import java.io.*;

public class GetAlltheAttachmentsFromPDF
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithattachments/getalltheattachmentsfrompdf/data/";
