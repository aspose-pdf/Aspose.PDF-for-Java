...
package programmersguide.workingwithasposepdf.workingwithtext.searchandgettextsegmentsfrompagesofpdf.java;
...
public class SearchandGetTextSegmentsfromPagesofPDF
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/searchandgettextsegmentsfrompagesofpdf/data/";
