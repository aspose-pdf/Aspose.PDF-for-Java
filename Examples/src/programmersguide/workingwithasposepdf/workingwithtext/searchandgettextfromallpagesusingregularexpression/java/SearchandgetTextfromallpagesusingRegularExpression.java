...
package programmersguide.workingwithasposepdf.workingwithtext.searchandgettextfromallpagesusingregularexpression.java;

import com.aspose.pdf.*;

public class SearchandgetTextfromallpagesusingRegularExpression
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/searchandgettextfromallpagesusingregularexpression/data/";
