...
package programmersguide.workingwithasposepdf.workingwithtext.searchandgettextfrompagesofpdf.java;

import com.aspose.pdf.*;

public class SearchandGetTextfromPagesofPDF
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/searchandgettextfrompagesofpdf/data/";
        ...
        // In order to search a text an get properties associated with it, please provide the page index against which you need to get the information. Take a look over following code line.
