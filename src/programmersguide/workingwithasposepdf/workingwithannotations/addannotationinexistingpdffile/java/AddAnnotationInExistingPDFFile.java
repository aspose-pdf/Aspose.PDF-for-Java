...
package programmersguide.workingwithasposepdf.workingwithannotations.addannotationinexistingpdffile.java;

import com.aspose.pdf.*;

public class AddAnnotationInExistingPDFFile
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithannotations/addannotationinexistingpdffile/data/";
