...
package programmersguide.workingwithasposepdf.workingwithtext.searchandgettextfromasinglepageusingregularexpression.java;

import com.aspose.pdf.*;

public class SearchandGetTextfromaSinglePageUsingRegularExpression
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/searchandgettextfromasinglepageusingregularexpression/data/";
