...
package programmersguide.workingwithasposepdf.workingwithpages.getpageproperties.java;
...
public class GetPageProperties
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithpages/getpageproperties/data/";
