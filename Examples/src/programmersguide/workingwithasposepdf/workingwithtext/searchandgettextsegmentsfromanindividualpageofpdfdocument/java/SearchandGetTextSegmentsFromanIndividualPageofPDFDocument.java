...
package programmersguide.workingwithasposepdf.workingwithtext.searchandgettextsegmentsfromanindividualpageofpdfdocument.java;

import com.aspose.pdf.*;

public class SearchandGetTextSegmentsFromanIndividualPageofPDFDocument
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/workingwithasposepdf/workingwithtext/searchandgettextsegmentsfromanindividualpageofpdfdocument/data/";
